        ...
        <table className="w-full table-auto">
            ...
            <tr className="text-left text-gray-600 border-b">
              <th className="p-4 text-center">
                <input
                  ...
                  checked={sortedList.every((item) => selectedIds.includes(item.id))}
                />
              </th>
              <th
              ...
              >
                Id đơn hàng {sortConfig.key === "order_id" && (sortConfig.direction === "asc" ? "▲" : "▼")}
              </th>
          ...
          <tbody>
            {sortedList.length > 0 ? (
              ...
              <tr>
                <td colSpan={showActions ? 5 : 4} className="p-4 text-center text-gray-500">

...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-r from-purple-500 via-blue-500 to-pink-500 p-6 text-white">
        ...
        <div className="flex justify-end items-center p-4 bg-gray-900 text-white rounded-2xl shadow-md">
      ...
      <div className="flex flex-1">
       ...
       <Sidebar />
        ...
        {/* Nội dung chính */}
        <div className="flex-1 bg-white p-6 rounded-2xl shadow-xl text-black">

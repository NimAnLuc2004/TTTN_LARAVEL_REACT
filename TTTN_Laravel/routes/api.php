...
Route::prefix('frontend')->group(function () {
	...
	//UC10: Tất cả sản phẩm
	Route::get('product_all', [FrontendProductController::class, 'productall']);
	Route::get('product_all1', [FrontendProductController::class, 'productall1']);
	//UC11: Chi tiết sản phẩm (product_detail/id/giới hạn)
	...
	Route::prefix('reviews')->group(function () {
		Route::get('/product/{product_id}', [FrotendReviewController::class, 'getByProductPaginated']); // Lọc theo product
		Route::get('/product/{product_id}/average', [FrotendReviewController::class, 'averageRating']); // Trung bình sao
	});
...
Route::prefix('frontend')->middleware('auth:sanctum')->group(function () {
	...
	//
	Route::get('/orders', [FrontendUserController::class, 'getOrders']);
	...
	Route::prefix('reviews')->group(function () {
		Route::post('/store', [FrotendReviewController::class, 'store']); // Tạo mới
		Route::get('/user/{user_id}', [FrotendReviewController::class, 'getByUser']); // Lọc theo user
		Route::put('/{id}', [FrotendReviewController::class, 'update']); // Cập nhật
		Route::delete('/{id}', [FrotendReviewController::class, 'destroy']); // Xóa
	});
	//order

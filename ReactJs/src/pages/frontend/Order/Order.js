...
const Order = () => {
  ...
  const createVNPayOrder = async () => {
    try {
      ...
      console.log("VNPay Payment URL:", confirmResponse.data.data.payment_url);
  ...
  return (
    <div className="container mx-auto p-5">
      ...
      {paymentMethod === "VNPay" && (
        <div className="bg-white p-5 rounded-lg shadow-sm mb-5">
          <h2 className="text-lg font-semibold mb-3">Thanh toán VNPay</h2>
          <button
      ...
      {paymentMethod === "Paypal" && (
        <div className="bg-white p-5 rounded-lg shadow-sm mb-5">
          <h2 className="text-lg font-semibold mb-3">Thanh toán PayPal</h2>

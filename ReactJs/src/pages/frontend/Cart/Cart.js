...
const Cart = () => {
  ...
  const API_URL = "https://zstore.click/api/frontend";
              ...
              >
                ...
                <div className="flex sm:col-span-2 sm:justify-center">
                  <div className="flex items-center border border-gray-300 rounded-md w-24 sm:w-28 mx-auto sm:mx-0">
                    ...
                    <span className="px-2 sm:px-3 py-1 text-gray-800">
                      {quantity}
                    </span>
                    <button
                  ...
                  {discountCode ? (
                    <div>
                      <del className="text-gray-500 text-xs sm:text-sm">
                        {formatVND(Math.floor(originalTotalPrice))}
                      </del>
                      <div className="text-sm sm:text-base">
                        {formatVND(Math.floor(totalItemPrice))}
                      </div>
                    </div>
                  ) : (
                    <div className="text-sm sm:text-base">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
            ...
            <div className="text-right">
              ...
              <span className="text-orange-500 text-lg sm:text-xl font-semibold">
                {formatVND(Math.floor(totalPrice))}
              </span>
            </div>
          </div>

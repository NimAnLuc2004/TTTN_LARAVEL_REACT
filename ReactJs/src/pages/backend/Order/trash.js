  ...
  return (
    <div>
      <div className="bg-white shadow rounded-md p-4 mb-6">
        <p className="text-sm text-gray-500">Home / Quản lý Đơn hàng / Thùng rác</p>
      </div>

      <section className="bg-white shadow rounded-md p-6">
        <h2 className="text-lg font-semibold mb-4">Thùng rác Đơn hàng</h2>
        <Link to="/admin/order" className="bg-blue-500 text-white px-4 py-2 rounded-md mb-4 inline-block">
          Quay lại
        </Link>

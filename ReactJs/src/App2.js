    ...
    <>
      ...
      <main className="font-medium">
        ...
        <div className="flex container mx-auto items-center">
          <div className="flex space-x-2 overflow-x-auto p-10">
            <button className="flex items-center px-4 py-2 bg-gray-200 hover:bg-orange-500 hover:text-white text-black rounded-md focus:outline-none">
              TẤT CẢ{" "}
              <span className="ml-2 bg-white text-orange-500 rounded-full px-2 py-0.5">
                57
              </span>
            </button>
            <button className="flex items-center px-4 py-2 bg-gray-200 hover:bg-orange-500 hover:text-white text-blacktext-white rounded-md focus:outline-none">
              SIMULATION{" "}
              <span className="ml-2 bg-white text-orange-500 rounded-full px-2 py-0.5">
                5
              </span>
            ...
            <button className="flex items-center px-4 py-2 bg-gray-200 hover:bg-orange-500 hover:text-white text-blacktext-white rounded-md focus:outline ">
              RACING{" "}
              <span className="ml-2 bg-white text-gray-700 rounded-full px-2 py-0.5">
                1
              </span>
        ...
        <div className="container mx-auto">
          <div className="flex flex-row-2 items-center text-lg ">
            <div className="md:basis-3/12">
              ...
              <i className="fa-brands fa-facebook text-4xl pr-6 pt-3"></i>
              <i className="fa-brands fa-youtube text-4xl pr-6 pt-3"></i>
              <i className="fa-brands fa-instagram text-4xl pr-6 pt-3"></i>
            </div>

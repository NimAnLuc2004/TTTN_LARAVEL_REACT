...
import CategoryFilter from "../pages/frontend/Category/CategoryFilter";
...
const RouterFrontend = [
  ...
  { path: "/brand/:id", element: <ProductList /> },
   { path: "/brand", element: <ProductList /> },
  ...
  {path:"/category", element:<CategoryFilter/>} ,
  {path:"/category/:categoryId", element:<CategoryFilter/>} ,
];

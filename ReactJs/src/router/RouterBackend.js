...
import UserDiscountAdd from "../pages/backend/UserDiscount/add";
import UserDiscountIndex from "../pages/backend/UserDiscount";
...
{ path: "/admin/topic", element: <NewTopicAdd /> },
  ...
  //user discount 
  { path: "/admin/userdiscount", element: <UserDiscountIndex /> },
    { path: "/admin/userdiscount/add", element: <UserDiscountAdd /> },
];

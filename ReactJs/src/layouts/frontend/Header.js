...
const Header = () => {
    ...
    const fetchMenus = async () => {
      try {
        const response = await fetch(
          "https://zstore.click/api/frontend/menu_list/10"
        );
  ...
  const fetchSuggestions = useCallback(async (query) => {
    ...
    try {
      const response = await fetch(
        `https://zstore.click/api/frontend/product_search?query=${encodeURIComponent(
          query
        )}`
      );
      ...
      try {
        if (token) {
          ...
          const wishlistResponse = await fetch(
            "https://zstore.click/api/frontend/wishlist/count",
            {
              headers: {
          ...
          const cartResponse = await fetch(
            "https://zstore.click/api/frontend/cart/count",
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
    ...
    <header className="relative">
      <div className="header-top bg-gray-100 py-2">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="header-alert-news text-sm text-center flex-1">
      ...
      <div className="header-main bg-white shadow-md py-4">
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="header-search-container relative w-3/5">
      ...
      <div className="mobile-bottom-navigation fixed bottom-0 left-0 right-0 bg-white shadow-t-md py-2 md:hidden z-50">
        <div className="container mx-auto px-4 flex justify-between">
          ...
          <button
            className="action-btn text-gray-600 relative"
            onClick={() => {
   
              setIsMobileMenuOpen(true); // Mở menu di động
              toggleMobileMenuCate("categories");
            }}
      ...
      <nav
        className={`mobile-navigation-menu fixed top-0 bg-white z-50 ${
          isMobileMenuOpen ? "active" : ""
        } md:hidden w-80 max-w-[80%]`}
        data-mobile-menu
      >
        ...
        <div className="menu-bottom p-4 border-t">
          <ul className="menu-category-list">
            ...
            {/* <li className="menu-category">
              ...
              <ul
                className={`submenu-category-list ${
                  isMobileMenuCateOpen["language"] ? "active" : ""
                } pl-4`}
              >
            ...
            {/* <li className="menu-category">
              ...
              <ul
                className={`submenu-category-list ${
                  isMobileMenuCateOpen["currency"] ? "active" : ""
                } pl-4`}
              >
                {["USD $", "EUR €"].map((cur) => (
